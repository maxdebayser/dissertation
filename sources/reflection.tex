% talvez seja uma boa usar as definicoes e termos do Lakos da secao 5.4
...
lines\cite{Czarnecki98} and implement object-oriented design patterns efficiently \cite{alexbook}. The introduction of templates that accept

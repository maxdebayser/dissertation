...
Smith also outlined six general properties of reflective systems. The first principle is the requirement a of causal connection between
...
Not only is this code more generic but it is also automatically handles new cases. It can even handle new cases at runtime: we could load
...
Hassoun \emph{et al.} interpret \texttt{Java'} dynamic proxies as the meta-objects of \texttt{CLOS}' meta-object protocol but
we think this is an overstatement because the possibilities of dynamic proxies are limited to intercepting method call and
...
Chuang \emph{et al.} \cite{Chuang} describe an introspection system for \texttt{C++} that aims at being non-intrusive and that supports

...
\texttt{ServiceBinding}, \textttt{ReferenceBinding}, \texttt{ServiceProxy} and \texttt{ServiceWrapper}. The runtime
...
\ref{ref:calccppccomponenttype} shows the componentType file for the calculator component. Notice
